...
TEST(single_linked_list, empty_list_add_cut_node)
{
    SLIST_t     slist;
...
TEST(single_linked_list, multi_add_node_at_head)
{
    INT         i;
    SLIST_t     slist;
    SNODE_t     nodes[NODE_COUNT];
...
TEST(single_linked_list, multi_add_node_at_tail)
{
    INT         i;
    SLIST_t     slist;
    SNODE_t     nodes[NODE_COUNT];
...
TEST(single_linked_list, multi_cut_node_at_head)
{
    INT         i;
    SLIST_t     slist;
    SNODE_t     nodes[NODE_COUNT];
...
TEST(single_linked_list, multi_cut_node_at_tail)
{
    INT         i;
    SLIST_t     slist;
    SNODE_t     nodes[NODE_COUNT];
